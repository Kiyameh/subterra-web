...
/**
 * @version 1
 * @description Función para obtener el tipo de archivo según la url de Cloudinary
...
/**
 * @version 1
 * @description Función para obtener el icono de un archivo según su tipo
...
/**
 * @version 1
 * @description Muestra las topografías de una cavidad
 * @param topographies
 */
